...
description: >-
  Produces a rough plan outline by invoking the rough-changes-planner agent,
  which writes a single rough-goals.md in .plan/YYYY-MM-DD/<slug>/. Presents the
  outline to the user for review. Use before plan-changes to align on goal,
  scope, and strategy.
---
