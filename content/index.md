...
The current [alert](https://github.com/nuxt/starter/blob/content/app/components/AppAlert.vue) and the [counter](https://github.com/nuxt/starter/blob/content/app/components/AppCounter.vue) below are `Vue` components integrated into the Markdown.
::
